...
<body>
	...
	<c:import url="/WEB-INF/jsp/include/navigation.jsp" />
	 <div id="wrap">
		<h2>회원가입</h2>
                <form role="form" autocomplete="off" action="${pageContext.request.contextPath }/user/join" method=post>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="PasswordCheck" placeholder="비밀번호 확인을 위해 다시한번 입력 해 주세요" required>
                    </div>
                    ...
                    <div class="form-group text-center">
                        ...
                        <button type="submit" class="btn btn-warning" onclick="location.href='/blinkist'">가입취소<i class="fa fa-times spaceLeft"></i></button>
                    </div>
                </form>
            </div>
</body>
