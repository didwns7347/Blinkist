...
public class Self_developmentCrawling {
	...
	public static void main(String args[]) {
		...
		Self_developmentCrawling crawling = new Self_developmentCrawling();
	...
	public void Info() {
		try {
			...
			for(int i=1; i<25; i++) {
				...
				if(i==2 || i==3 || i==6 || i==7 || i==8 || i==9 || i==14 || i==16 || i==20 || i==21 || i==23 || i==24) {
